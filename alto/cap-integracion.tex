...
Este es un capítulo que tiene como objetivo explicar como se integran entre si las herramientas del proyecto, Ksensor con las modificaciones expuestas y los módulos de trazas y estadísticas. Para guiar la explicación, se aconseja se siga el diagrama \reference{fig:integracion-modular}{Figura de integración de los módulos}
\\
\begin{figure}[h]
\centering
