...
A continuación se explicarán las funciones y características de cada uno indicando las consideraciones a tener en cuenta, para una mayor descripción, referirse al documento de diseño de bajo nivel.
...
Durante el desarrollo de la prueba, el demonio estará inactivo, y al finalizar, volcará en un fichero los datos y se los enviará a través del agente al gestor.