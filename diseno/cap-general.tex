...
Existen diferentes estrategias para capturar el tráfico de red, cada cual con sus ventajas e inconvenientes, que serán relevantes para explicar el problema que hay a la hora de intentar que un :
...
La implementación anterior, si bien entendía como necesaria el uso del sistema descrito en \cite{JMKR96}, había integrado esa lógica dentro del resto de la estructura encargada de la administración de la tarjeta de red.

Con el paso de los años, desde 2005, empezaron a salir las tarjetas con varias interfaces de red, y como cabía la posibilidad de que solo se hubieran recibido paquetes en una de ellas, se decidió separar de una manera virtual estas tarjetas. Con el paso de los años, se empezó a separar de manera lógica la gestión del interfaz físico persé y la administración de los interfaces virtuales.

Por ese motivo, ahora que ya está totalmente separado uno del otro, el diseño de Ksensor se debe adaptar a la lógica del kernel de captura de paquetes.