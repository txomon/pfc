...
Ksensor, al contrario de lo que se pensaba, no era tan óptimo como se pensaba en computadoras multinúcleo de gran potencia. Tras un análisis del código, se han podido identificar varios segmentos del mismo que tienen secciones críticas demasiado grandes, e incluso, secciones críticas que no son necesarias por el diseño del sistema.
...
Uno de los cambios de diseño propuestos para Ksensor es la asignación variable de cupos de paquetes. Una instancia, que por el motivo que fuera se queda bloqueada en el acceso a la cola, cogerá un paquete más cada vez que se quede bloqueado al intentar acceder a la cola.

Es importante especificar que el diseño que se plantea no tiene como objetivo que un hilo de Ksensor acabe cogiendo cada vez más paquetes, por ello debe distinguirse entre que aumente el tiempo de bloqueo porque no hay paquetes y porque haya otras instancias intentando acceder.
